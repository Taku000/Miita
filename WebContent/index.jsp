...
<body>
		...
		<div id="register_area">
			...
			<div id="modal-content">
				...
				<form name="regist_article" method="post" action="Home">
					...
					<div class="URL">
						URL: <input type="text" name="regist_url" class="URL_text"
							placeholder="登録したい記事のURLを入力"></input>
					</div>
					<p></p>
					<div class="category">
						カテゴリ: <select name="category1" class="category1">
							<option disabled value="" selected>登録カテゴリを選択</option>
							<option value="kaihatu">開発</option>
							<option value="koutiku">構築</option>
							<option value="DB">DB</option>
							<option value="other">その他</option>
						</select> <select name="category2" class="category2">
	...
	<form method="GET" id="search_form" action="Home">
		<input type="text" placeholder="検索キーワードを入力" name="search_keyword"
			id="search_box">
	...
	<div id="contents_area">
		...
		<form method="GET" action="Home">
			<select name="sort" class="sort_box">
				...
				<option value="投稿順"
					<%="投稿順".equals(sortWord) ? " selected=\"selected\"" : ""%>>投稿順</option>
				<option value="閲覧数順"
					<%="閲覧数順".equals(sortWord) ? " selected=\"selected\"" : ""%>>閲覧数順</option>
			</select>
			<%
			...
			<div id="article_base">
				<div id="article_text">
					...
					<div id="article2">
						...
						<div class="view_int">
							閲覧数:<%=articleList.get(i).getAccess()%>
						</div>
					</div>
				</div>
			</div>
